...
import { RegulacionesVAContent } from "@/app/resources/resource-content-regulations"

export default function RegulacionesVAPage() {
        ...
        <FadeIn delay={0.2}>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none mb-8">
              {language === "es" ? <RegulacionesVAContent /> : null}
            </div>
